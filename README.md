...
This dashboard provides comprehensive cost monitoring for all Cortex Agents in your Snowflake account, tracking both Cortex Analyst text-to-SQL generation costs and warehouse compute costs for AI-generated query execution across multiple time periods (1d, 3d, 7d, 30d). The dashboard shows total consumption with detailed breakdowns by warehouse usage, usage trends over time, and raw request data, while automatically detecting your Snowflake edition to provide both credit consumption and estimated dollar cost views.
...
- **Cortex Search costs** - Knowledge base indexing and search consumption
- **Individual agent cost isolation** - Shows total costs across all Cortex Agents
